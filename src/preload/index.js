...
contextBridge.exposeInMainWorld('hw', {
  ...
  screenshotsList: (dir) => ipcRenderer.invoke('screenshots:list', dir),
  screenshotFull: (p, dir) => ipcRenderer.invoke('screenshots:full', p, dir),
  screenshotDelete: (p, dir) => ipcRenderer.invoke('screenshots:delete', p, dir),
  screenshotShow: (p) => ipcRenderer.invoke('screenshots:show', p),
  skinUpload: (variant) => ipcRenderer.invoke('skin:upload', variant),
  skinApply: (p, variant) => ipcRenderer.invoke('skin:apply', p, variant),
  skinsList: () => ipcRenderer.invoke('skins:list'),
  discordInfo: () => ipcRenderer.invoke('discord:info'),
